#!/usr/bin/env python3
"""
Debug booking creation to identify the exact issue
"""
...
async def test_booking_debug():
    """Test booking creation with detailed error reporting."""
...
if __name__ == "__main__":
    asyncio.run(test_booking_debug())
